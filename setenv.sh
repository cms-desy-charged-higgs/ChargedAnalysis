...
case $1 in
    ...
    "StandAlone")
        ...
        export LD_LIBRARY_PATH=$CHDIR/Anaconda3/lib:$CHDIR/ChargedAnalysis/Analysis/lib:$CHDIR/ChargedAnalysis/Network/lib:$CHDIR/Anaconda3/lib/python3.7/site-packages/torch/lib
